...
1. Place the agent module at ``agents/blockchain_mastery/<role>/agent.py`` exporting
...
DEPARTMENT_NAME = "blockchain_mastery"
DEPARTMENT_DESCRIPTION = "Smart-contract auditing, tokenomics, Web3 integration"
