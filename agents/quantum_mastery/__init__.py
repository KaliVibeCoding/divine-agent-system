...
1. Place the agent module at ``agents/quantum_mastery/<role>/agent.py`` exporting
...
DEPARTMENT_NAME = "quantum_mastery"
DEPARTMENT_DESCRIPTION = "Qiskit-backed quantum algorithm / circuit / ML experiments"
