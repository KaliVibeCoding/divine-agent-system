...
1. Place the agent module at ``agents/web_mastery/<role>/agent.py`` exporting
...
DEPARTMENT_NAME = "web_mastery"
DEPARTMENT_DESCRIPTION = "Full-stack web (frontend, backend, API, DB, perf, testing)"
