#!/usr/bin/env python3
"""
System Orchestration Department
===============================
...
1. Place the agent module at ``agents/system_orchestration/<role>/agent.py`` exporting
...
DEPARTMENT_NAME = "system_orchestration"
DEPARTMENT_DESCRIPTION = "Cross-department supervisor & global state manager"
