...
1. Place the agent module at ``agents/security_fortress/<role>/agent.py`` exporting
...
DEPARTMENT_NAME = "security_fortress"
DEPARTMENT_DESCRIPTION = "Cybersecurity, compliance, threat detection"
