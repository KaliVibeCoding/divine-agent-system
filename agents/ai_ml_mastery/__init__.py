...
1. Place the agent module at ``agents/ai_ml_mastery/<role>/agent.py`` exporting
...
DEPARTMENT_NAME = "ai_ml_mastery"
DEPARTMENT_DESCRIPTION = "Applied ML / MLOps / AutoML / NLP / computer-vision agents"
