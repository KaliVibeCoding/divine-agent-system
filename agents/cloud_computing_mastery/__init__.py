#!/usr/bin/env python3
"""
Cloud Computing Mastery Department
==================================
...
1. Place the agent module at ``agents/cloud_computing_mastery/<role>/agent.py`` exporting
...
DEPARTMENT_NAME = "cloud_computing_mastery"
DEPARTMENT_DESCRIPTION = "Per-provider experts (AWS / Azure / GCP) and DevOps orchestrator"
