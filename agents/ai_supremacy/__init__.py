...
1. Place the agent module at ``agents/ai_supremacy/<role>/agent.py`` exporting
...
DEPARTMENT_NAME = "ai_supremacy"
DEPARTMENT_DESCRIPTION = "Advanced AI / ethics / consciousness-simulation research agents"
