...
1. Place the agent module at ``agents/data_omniscience/<role>/agent.py`` exporting
...
DEPARTMENT_NAME = "data_omniscience"
DEPARTMENT_DESCRIPTION = "Analytics, big data, ETL, visualisation"
